...
# GuardRail #2
removeDeprecatedAccount = "Supprimer les comptes obsolètes"
removeExternalAccount = "Supprimer les comptes externes"
...
removeGuestAccounts = "Supprimer les comptes invités d'Azure AD."
